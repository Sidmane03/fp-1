    ...
    <div className="space-y-5 animate-[fadeInUp_0.3s_ease-out]">
      ...
      <div className="px-1 flex justify-between items-start">
        ...
        <button
          ...
          className={`shrink-0 w-10 h-10 flex items-center justify-center rounded-2xl border transition-all ${theme === "light" ? "bg-white border-gray-100 text-[#1A1A1A] shadow-sm" : "bg-gray-900 border-gray-800 text-white"
            }`}
        >
          {theme === "light" ? (
      ...
      {isCheckInDay && !weekWeight && (
        <button
          ...
          className={`w-full border rounded-2xl p-4 flex items-center justify-between text-left group transition-all duration-300 ${theme === "light"
        ...
        >
          ...
          <div className={`w-8 h-8 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform ${theme === "light" ? "bg-blue-100 text-blue-600" : "bg-blue-500/20 text-blue-400"
            }`}>
      ...
      <div className={cardBase}>
        ...
        <div className="flex justify-between items-center mb-6 px-1">
          {weekDates.map(({ day, date, isToday }) => (
            <div key={day} className="flex flex-col items-center gap-1.5">
              ...
              <div
                className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 ${isToday
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="space-y-2 max-h-[180px] overflow-y-auto pr-1 custom-scrollbar">
              {todayLog.items.map((item) => (
                <div
                  key={item.id}
                  className={`flex items-center justify-between group rounded-2xl px-4 py-3 border transition-all ${theme === "light" ? "bg-gray-50/50 border-gray-100/50 hover:bg-gray-50" : "bg-gray-800/20 border-gray-800/40 hover:bg-gray-800/40"
                    }`}
                >
          ...
          <div className="space-y-4 animate-[fadeInUp_0.2s_ease-out]">
            <div className="space-y-3">
              <input
                ...
                autoFocus
                className={`w-full px-5 py-3.5 rounded-2xl border font-bold text-base focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all ${theme === "light" ? "bg-gray-50 border-gray-100 text-[#1A1A1A] placeholder:text-gray-300" : "bg-gray-800 border-gray-700 text-white placeholder:text-gray-600"
                  }`}
              />
              <div className="flex items-center gap-3">
                <input
                  ...
                  className={`flex-1 px-5 py-3.5 rounded-2xl border font-bold text-lg focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all ${theme === "light" ? "bg-gray-50 border-gray-100 text-[#1A1A1A] placeholder:text-gray-300" : "bg-gray-800 border-gray-700 text-white placeholder:text-gray-600"
                    }`}
                />
                <button
        ...
        {todayLog && !showCalInput && (
          <button
            onClick={onShowCalInput}
            className={`w-full py-3.5 rounded-2xl border-2 border-dashed font-bold text-xs transition-all flex items-center justify-center gap-2 ${theme === "light" ? "bg-white border-gray-100 text-gray-400 hover:border-gray-200 hover:text-gray-500" : "bg-transparent border-gray-800 text-gray-500 hover:border-gray-700 hover:text-gray-400"
              }`}
          >
